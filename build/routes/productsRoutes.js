...
class ProductsRoutes {
    ...
    config() {
        ...
        this.router.get('/productsStock/', productsController_1.default.listWithStock);
        this.router.get('/:id', productsController_1.default.getOne);
        this.router.get('/stockProduct/:id', productsController_1.default.getStockOneProduct);
